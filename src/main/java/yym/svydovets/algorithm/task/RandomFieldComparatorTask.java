 ...
 */
public class RandomFieldComparatorTask<T> implements Comparator<T> {

  public RandomFieldComparatorTask(Class<T> targetType) {
  ...
  private static class Demo1 {
    ...
    public static void main(String[] args) {
      Comparator<Account> accountComparator = new RandomFieldComparatorTask<>(Account.class);
