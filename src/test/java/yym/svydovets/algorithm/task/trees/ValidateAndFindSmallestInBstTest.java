...
class ValidateAndFindSmallestInBstTest {
  ...
  void testIsValid_v1() {
    ...
    var actual = ValidateAndFindSmallestInBst.isValidBST(root);
  ...
  void testIsValid_v4() {
    ...
    var actual = ValidateAndFindSmallestInBst.isValidInOrderTraversal(root);
  ...
  void testKthSmallest_v1() {
    ...
    var actual = ValidateAndFindSmallestInBst.kthSmallest(root, k);
