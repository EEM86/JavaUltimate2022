...
class SquaresOfNumsTest {
    ...
    @Test
    void testFindSquare() {
        final List<Integer> res = SquaresOfNums.findSquaresIterative(16);
        assertEquals(4, res.get(0));
    }

    @Test
    void testFindSquare2() {
        final List<Integer> res = SquaresOfNums.findSquaresIterative(30);
    ...
    void testFindSquare3() {
        final List<Integer> res = SquaresOfNums.findSquaresIterative(4);
        assertEquals(2, res.get(0));
    }

    @Test
    void testFindSquare4() {
        final List<Integer> res = SquaresOfNums.findSquaresIterative(3);
        assertEquals(1, res.get(0));
