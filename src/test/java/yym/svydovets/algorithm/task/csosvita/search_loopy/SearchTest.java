...
class SearchTest {
    ...
    void search() {
        ...
        final String result = Search.search(arr, 2);
    ...
    void search2() {
        int[] arr = new int[]{1,2,2,2,3,4};
        final String result = Search.search(arr, 3);
    ...
    void search3() {
        int[] arr = new int[]{1,2,2,2,3,4};
        final String result = Search.search(arr, 5);
    ...
    void search4() {
        ...
        final String result = Search.search(arr, 4);
        assertEquals("-1 -1 0", result);
    }
}